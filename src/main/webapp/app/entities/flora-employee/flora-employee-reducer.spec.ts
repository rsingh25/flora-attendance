...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLORAEMPLOYEE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FLORAEMPLOYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FLORAEMPLOYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FLORAEMPLOYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FLORAEMPLOYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FLORAEMPLOYEE actions', async () => {
      const expectedActions = [
        {
