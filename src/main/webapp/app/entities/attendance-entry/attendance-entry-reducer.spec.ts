...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATTENDANCEENTRY_LIST actions', async () => {
    ...
    it('dispatches FETCH_ATTENDANCEENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ATTENDANCEENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ATTENDANCEENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ATTENDANCEENTRY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ATTENDANCEENTRY actions', async () => {
      const expectedActions = [
        {
